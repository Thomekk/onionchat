#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Обновлён 7 — баннер убран + мерцание исправлено (финальная стабильная версия)
...
# ------------------ ГЛОБАЛЬНОЕ ПОДАВЛЕНИЕ БАННЕРА FLASK (самое важное!) ------------------
    ...
    def run(self):
        while self.running:
            ...
            if key != -1:
                ...
                time.sleep(0.035)   # ← главное исправление мерцания и ввода в Termux
