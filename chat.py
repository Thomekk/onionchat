#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Обновлён 4 — banner + клавиатура Termux исправлены
...
#  как в исходном коде — оставлены без изменений)
...
class ChatClient:
    def __init__(self, stdscr):
        ...
        # === ИСПРАВЛЕНИЕ КЛАВИАТУРЫ TERMUX ===
        curses.cbreak()
        curses.noecho()
        self.stdscr.keypad(True)
        self.stdscr.timeout(120)   # polling — главное исправление бага
    ...
    def run(self):
        while self.running:
            ...
            if key != -1:          # ← главное исправление клавиатуры
                self.handle_input(key)

# ------------------ Запуск Flask ------------------
def run_flask():
    # FIX: полное подавление баннера Flask
